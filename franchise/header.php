        ...
        <div class="header-inner">
            ...
            <div class="branding">
                ...
                <h1 class="logo">
                    ...
                    <a href="index.php"><img src="images/logo@2x.png" alt=""><span>CASEKART</span></a>
...
<!-- 
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <a href="pages-services2.php">Services</a>
...
<!--                                <ul class="sub-nav">
  ...
  <!--                           <li class="menu-item-has-children mega-menu-item mega-column-4">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <a href="portfolio-fancy-grid-3columns.php">Portfolio</a>
...
<!-- 
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <a href="pages-contact1.php">Contact</a>
